...
<html lang="fr" dir="ltr">
    ...
    <body class="colorBackgroundBody">
            ...
            <div class="row">
                <div class="col-6 mx-auto">
                    <div class="exerciceConsign p-2 mt-3">
                        <i>Afficher le nombre de jour dans le mois de février de l'année 2016.</i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php
        $februaryDay = cal_days_in_month(CAL_GREGORIAN, 02, 2016)
        ?>



        <div class="februaryPastDay text-center mt-3">
            <p>Le mois de février 2016 comportait <?= $februaryDay; ?> jours!</p>
        </div>
