    ...
    ?>
            ...
            foreach ($days as $day) { // j'appels mon tableau des jours
                ?>
                            ...
                            <th ><b><i><?= $day; ?></i></b></th> <!-- j'affiche mon tableau des jours -->
                ...
                <tbody>
                    ...
                    <td colspan="<?= $daysWeek; ?>"></td> <!--je créer un colspan et j'intègre le daysweek -->
                    ...
                    <td class="align-baseline bg-white"><?= $currentDays; ?></td> <!-- J'affiche les currentsday -->
                ...
                if ($daysWeeks != 0) { // si daysweek est différend de 0
                    ...
                    <td colspan="<?= $newDays; ?>"></td> <!-- j'appelle ma variable newdays -->
