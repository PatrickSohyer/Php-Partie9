...
<html lang="fr" dir="ltr">
    ...
    <body class="colorBackgroundBody">
            ...
            <div class="row">
                <div class="col-6 mx-auto">
                    <div class="exerciceConsign p-2 mt-3">
                        <i>Afficher la date courante avec le jour de la semaine et le mois en toutes lettres (ex : mardi 2 août 2016)
                            Bonus : Le faire en français.</i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="timeClock text-center mt-3">
            <p>On est le</p>
            <p class="date"><b><?= strftime('%A %d %B %Y'); ?></b></p>
        </div>
